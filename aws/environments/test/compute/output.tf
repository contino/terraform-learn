...
output "demo_node_dependency_id"    { value = "${module.demo-node-dependency.demo_node_instance_id}" }
output "demo_node_dependency_ip"    { value = "${module.demo-node-dependency.demo_node_ip}" }
